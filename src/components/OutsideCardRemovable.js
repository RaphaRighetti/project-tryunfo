...
import NewCardRemovable from './newCardRemovable';

class OutsideCardRemovable extends React.Component {
  render() {
...
OutsideCardRemovable.defaultProps = {
  cardName: 'titulo',
...
OutsideCardRemovable.propTypes = {
...
export default OutsideCardRemovable;
